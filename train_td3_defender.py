...
ALGORITHM_NAME = 'TD3_DEFENDER'

def train_td3(env_name : str, n_episodes : int, seed : int, batch_size : int, n_demos : int, dtw_safe_key : str, dtw_unsafe_key : str, save_every : int, traj_type : str):
    ...
    for episode in range(n_episodes):
        ...
        while not done:
            ...
            td3_agent.remember(observation, action, reward, new_observation, done, bc = 0, imagined = int(filtered))
            state_batch, action_batch, reward_batch, new_state_batch, done_batch, bc_batch, imagined_batch = td3_agent.get_batch()
